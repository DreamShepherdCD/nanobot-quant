...
RUN echo "[bust=66]" && pip install --break-system-packages \
        git+https://github.com/DreamShepherdCD/nanobot-quant.git@bbd424c \
        git+https://github.com/DreamShepherd2006/Vibe-Trading.git@v0.1.12 \
    && echo "✅ nanobot-quant @3079c37 (CD fork feat/td-live-b3 — P2 B3 TD live lifecycle VERIFY, bust=66) + vibe-trading @v0.1.12"
